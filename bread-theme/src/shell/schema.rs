...
pub fn describe() -> Value {
    ...
    json!({
        "tokens": {
            ...
            "ws_gradient_angle": { "type": "int", "default": d.ws_gradient_angle, "unit": "deg" },
            "chip_gap":        { "type": "int",   "default": d.chip_gap, "unit": "px" },
            "sep_style":       { "type": "enum",  "default": d.sep_style,
                                 "values": ["line", "none", "dot"] },
            "bar_shadow":      { "type": "enum",  "default": d.bar_shadow,
                                 "values": ["none", "soft", "hard"] },
            "media_eq_style":  { "type": "enum",  "default": d.media_eq_style,
                                 "values": ["bars", "none"] },
            "osd_style":       { "type": "enum",  "default": d.osd_style,
                                 "values": ["pill", "bar"] },
        },
